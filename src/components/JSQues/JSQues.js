...
const JSQues = () => {
    return (
        <div>
            ...
            <h2 className="py-2 fw-bold mt-5 text-center">JavaScript Questions</h2>
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo"
                        data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                        The <b>useState()</b> is a react hook that allows to have state variables in functional components. React has two different types of components and they are className components and functional components. Nowadays, functional components have been more used than functional components. This hook is a special function that takes the initial state as an argument and returns an array of two entries.
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
